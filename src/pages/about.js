...
export default function AboutPage() {
  ...
  return (
    <Layout>
      ...
      <svg width="50" height="50" viewBox="0 0 50 50" className="transform-[rotate(-90deg)] fixed lg:hidden">
      ...
      <motion.div exit={{ opacity: 0 }} initial='initial' animate='animate'>
        <motion.div variants={stagger} ref={ref} className="sm:h-[100vh] lg:h-[auto] flex flex-col gap-[20px] pt-20 pb-40 overflow-y-scroll ...">
